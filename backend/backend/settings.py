...
SECRET_KEY = 'django-insecure-4ezjz8mfxi9n=$s13(fiqsa4tda*j9xkjp7l*q3gs7@%4y0%(d'
...
DATABASES = {
    'default': {
        ...
        'USER': 'lemein',      # Your PostgreSQL user
        'PASSWORD': 'thisistooeasy',  # Use the actual password
